...
use tui::widgets::{Block, Borders, BorderType, Paragraph, Tabs, Table, Row, Cell, List, ListItem, ListState};
...
fn render_frame(rect: &mut Frame<CrosstermBackend<Stdout>>, menu_titles: &Vec<&str>, active_menu_item: &mut MenuItem,
